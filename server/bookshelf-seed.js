...
const onlineBooks = [
  ...
  { title: 'The Founders', author: 'Jimmy Soni', tags: ['startups', 'business', 'technology'] },
  ...
  { title: 'Ghost in the Wires', author: 'Kevin Mitnick & William L. Simon', tags: ['memoir', 'technology', 'security'] },
  { title: 'George Lucas: A Life', author: 'Brian Jay Jones', tags: ['biography', 'film', 'creativity'] },
  ...
  { title: 'Hackers: Heroes of the Computer Revolution', author: 'Steven Levy', tags: ['technology', 'history', 'computer science'] },
  ...
  { title: 'How to Make a Few More Billion Dollars', author: 'Brad Jacobs', tags: ['business', 'entrepreneurship', 'management'] },
  ...
  { title: 'Masters of Doom', author: 'David Kushner', tags: ['technology', 'game design', 'biography'] },
  ...
  { title: 'Permission Marketing', author: 'Seth Godin', tags: ['marketing', 'business'] },
  ...
  { title: 'Purple Cow', author: 'Seth Godin', tags: ['marketing', 'business'] },
  ...
  { title: 'Sam Walton: Made in America', author: 'Sam Walton & John Huey', tags: ['memoir', 'business', 'retail'] },
  ...
  { title: 'Alfred Nobel: A Life from Beginning to End', author: 'Hourly History', tags: ['biography', 'history', 'science'] },
  { title: 'Apple: The First 50 Years', author: 'David Pogue', tags: ['technology', 'business', 'history'] },
  { title: 'Art & Fear', author: 'David Bayles & Ted Orland', tags: ['art', 'creativity', 'self-help'] },
  { title: 'Atomic Accidents', author: 'James Mahaffey', tags: ['history', 'science', 'nuclear'] },
  { title: 'Autobiography of Mark Twain', author: 'Mark Twain', tags: ['memoir', 'classic', 'literature'] },
  { title: 'Belichick', author: "Ian O'Connor", tags: ['biography', 'sports'] },
  { title: 'Beartown', author: 'Fredrik Backman', tags: ['fiction', 'literature'] },
  { title: 'The Book Thief', author: 'Markus Zusak', tags: ['fiction', 'historical fiction'] },
  { title: 'The 48 Laws of Power', author: 'Robert Greene', tags: ['psychology', 'politics', 'self-help'] },
  { title: 'The Alignment Problem', author: 'Brian Christian', tags: ['AI', 'technology', 'ethics'] },
  { title: 'As I Please, 1943-1945', author: 'George Orwell', tags: ['essays', 'journalism', 'literature'] },
  { title: 'The Elements of Computing Systems', author: 'Noam Nisan & Shimon Schocken', tags: ['computer science', 'software engineering', 'education'] },
  { title: 'Empire of AI', author: 'Karen Hao', tags: ['AI', 'technology', 'business'] },
  { title: 'Destiny of the Republic', author: 'Candice Millard', tags: ['history', 'biography', 'politics'] },
  { title: 'The Grand Chessboard', author: 'Zbigniew Brzezinski', tags: ['geopolitics', 'history', 'politics'] },
  { title: 'The House of Gucci', author: 'Sara G. Forden', tags: ['business', 'biography', 'fashion'] },
  { title: 'How to Fail at Almost Everything and Still Win Big', author: 'Scott Adams', tags: ['self-help', 'business', 'memoir'] },
  { title: 'How to Live a Meaningful Life', author: 'Bill Burnett & Dave Evans', tags: ['self-help', 'design', 'philosophy'] },
  { title: 'The Humane Interface', author: 'Jef Raskin', tags: ['design', 'technology', 'software'] },
  { title: 'Just for Fun', author: 'Linus Torvalds & David Diamond', tags: ['memoir', 'technology', 'software engineering'] },
  { title: 'The Kite Runner', author: 'Khaled Hosseini', tags: ['fiction', 'literature'] },
  { title: 'The Mathematical Theory of Communication', author: 'Claude E. Shannon & Warren Weaver', tags: ['mathematics', 'communication', 'computer science'] },
  { title: 'My Years with General Motors', author: 'Alfred P. Sloan Jr.', tags: ['business', 'memoir', 'management'] },
  { title: 'No Ordinary Time', author: 'Doris Kearns Goodwin', tags: ['history', 'biography', 'politics'] },
  { title: 'Novelist as a Vocation', author: 'Haruki Murakami', tags: ['writing', 'memoir', 'literature'] },
  { title: 'John Adams', author: 'David McCullough', tags: ['biography', 'history', 'politics'] },
  { title: 'Longitude', author: 'Dava Sobel', tags: ['science', 'history', 'biography'] },
  { title: 'Oscar Wilde', author: 'Richard Ellmann', tags: ['biography', 'literature'] },
  { title: 'The Overstory', author: 'Richard Powers', tags: ['fiction', 'nature', 'literature'] },
  { title: 'Paul Rand: A Designer\'s Art', author: 'Paul Rand', tags: ['design', 'art', 'creativity'] },
  { title: 'The Professor and the Madman', author: 'Simon Winchester', tags: ['history', 'language', 'biography'] },
  { title: 'Random Reminiscences of Men and Events', author: 'John D. Rockefeller', tags: ['memoir', 'business', 'classic'] },
  { title: 'The Rise of Theodore Roosevelt', author: 'Edmund Morris', tags: ['biography', 'history', 'politics'] },
  { title: 'Siddhartha', author: 'Hermann Hesse', tags: ['fiction', 'philosophy', 'classic'] },
  { title: 'The Score Takes Care of Itself', author: 'Bill Walsh, Steve Jamison & Craig Walsh', tags: ['leadership', 'sports', 'management'] },
  { title: 'Startup Playbook', author: 'Sam Altman', tags: ['startups', 'business', 'technology'] },
  { title: 'Thomas Jefferson: The Art of Power', author: 'Jon Meacham', tags: ['biography', 'history', 'politics'] },
  { title: 'Three Men in a Boat', author: 'Jerome K. Jerome', tags: ['fiction', 'humor', 'classic'] },
  { title: 'Truman', author: 'David McCullough', tags: ['biography', 'history', 'politics'] },
  { title: 'The Dip', author: 'Seth Godin', tags: ['business', 'self-help', 'marketing'] },
  { title: 'The Seven Principles for Making Marriage Work', author: 'John M. Gottman & Nan Silver', tags: ['relationships', 'psychology', 'self-help'] },
  { title: 'Unbroken', author: 'Laura Hillenbrand', tags: ['biography', 'history', 'war'] },
  { title: 'Thoughts on Design', author: 'Paul Rand', tags: ['design', 'art', 'creativity'] },
  { title: '79 Short Essays on Design', author: 'Michael Bierut', tags: ['design', 'essays', 'art'] },
  { title: 'Trust Me, I\'m Lying', author: 'Ryan Holiday', tags: ['marketing', 'media', 'business'] },
  { title: 'Turn the Ship Around!', author: 'L. David Marquet', tags: ['leadership', 'management'] },
  { title: 'Us Against You', author: 'Fredrik Backman', tags: ['fiction', 'literature'] },
  { title: 'What Do You Care What Other People Think?', author: 'Richard P. Feynman', tags: ['memoir', 'science', 'physics'] },
  { title: 'Where Wizards Stay Up Late', author: 'Katie Hafner & Matthew Lyon', tags: ['technology', 'history', 'internet'] },
];
...
const physicalBooks = [
  ...
  { title: 'The Goldfinch', author: 'Donna Tartt', tags: ['fiction', 'literature'] },
  { title: 'Правила будинку сидру', author: 'Джон Ірвінг', tags: ['fiction', 'literature', 'Ukrainian literature'] },
  ...
  { title: "It's a Long Story: My Life", author: 'Willie Nelson & David Ritz', tags: ['memoir', 'music'] },
  ...
  { title: 'The Tibetan Book of the Dead', author: 'Robert A. F. Thurman', tags: ['spirituality', 'Buddhism', 'philosophy'] },
  ...
  { title: 'Пазл', author: 'Франк Тільє', tags: ['fiction', 'thriller', 'mystery', 'Ukrainian literature'] },
  ...
  { title: 'The Art of Curiosity', author: 'Exploratorium', tags: ['art', 'science', 'creativity'] },
  ...
  { title: 'Tinker Tailor Soldier Spy', author: 'John le Carre', tags: ['fiction', 'spy fiction', 'thriller'] },
  { title: 'The Peregrine', author: 'J. A. Baker', tags: ['nature', 'memoir', 'classic'] },
  { title: 'Cable Cowboy', author: 'Mark Robichaux', tags: ['biography', 'business', 'technology'] },
  { title: 'The Outsiders', author: 'William N. Thorndike', tags: ['business', 'management', 'investing'] },
  { title: 'Genius: The Life and Science of Richard Feynman', author: 'James Gleick', tags: ['biography', 'science', 'physics'] },
  { title: 'The Idea Factory', author: 'Jon Gertner', tags: ['technology', 'history', 'business'] },
  { title: 'The Spy and the Traitor', author: 'Ben Macintyre', tags: ['history', 'spy fiction', 'biography'] },
  { title: 'Several Short Sentences About Writing', author: 'Verlyn Klinkenborg', tags: ['writing', 'essays'] },
  { title: 'Complexity: A Guided Tour', author: 'Melanie Mitchell', tags: ['science', 'complexity', 'computer science'] },
  { title: 'The Timeless Way of Building', author: 'Christopher Alexander', tags: ['architecture', 'design', 'systems'] },
  { title: 'The Information', author: 'James Gleick', tags: ['science', 'technology', 'history'] },
  { title: 'The Man Who Solved the Market', author: 'Gregory Zuckerman', tags: ['finance', 'investing', 'biography'] },
  { title: 'Dealers of Lightning', author: 'Michael A. Hiltzik', tags: ['technology', 'history', 'business'] },
  { title: 'The Making of the Atomic Bomb', author: 'Richard Rhodes', tags: ['history', 'science', 'physics'] },
...
const titleCorrections = [
  { fromTitle: '21 Letters on Life and Its Challenges', fromAuthor: 'Charles Handy', title: '21 лист про життя і його виклики', author: 'Чарльз Генді' },
  { fromTitle: 'The Cider House Rules', fromAuthor: 'John Irving', title: 'Правила будинку сидру', author: 'Джон Ірвінг' },
  { fromTitle: 'Puzzle', fromAuthor: 'Franck Thilliez', title: 'Пазл', author: 'Франк Тільє' },
...
async function seed() {
  ...
  for (const book of allBooks) {
    ...
    booksByKey.set(bookKey, existingBook
      ? {
        ...book,
        isOnline: Boolean(existingBook.isOnline || book.isOnline),
        url: existingBook.url || book.url,
        tags: mergeTags(existingBook.tags, book.tags),
      }
      : book);
  }
